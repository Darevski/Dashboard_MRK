...
class Safe_SQL
{
    ...
    /**
     * Conventional function to get number of rows in the result set.
     *
     * @param resource $result - mysqli result
    ...
    /**
     * Conventional function to free the result set.
     */
    ...
    /**
     * Helper function to get all the rows of result set right out of query and optional arguments
     *
     * Examples:
    ...
    /**
     * Helper function to get all the rows of result set into indexed array right out of query and optional arguments
     *
     * Examples:
